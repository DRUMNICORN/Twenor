...
import { CONFIG } from '@/hooks/useThemeMode';
...
const WaveformBars: React.FC<Props> = ({ handleFileUpload, barData, currentTime, audioBuffer, numberOfBars, duration }) => {
    ...
    return (
        <div onDrop={handleDrop} className={styles.waveformBarsContainer} style={{ height: '100px' }}>
