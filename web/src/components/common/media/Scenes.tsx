...
const Scenes: React.FC<ScenesProps> = ({ scenes, handleSceneClick, selectedScene }) => {
    ...
    const handleUpdateScene = (direction) => {
        ...
        if (isMakingSceneShorter && leftScene.scene_chunks.length <= 1) {
            console.log("No more chunks to remove", leftScene);
            return;
        }
